      ...
      <div className='bg-color max-w-xs lg:max-w-sm mx-auto my-auto py-8 px-8 lg:py-10 rounded-xl shadow-lg border mt-16'>
        ...
        <div className='py-4'>
          <div className='flex justify-between text-white'>
            <div>
              <button onClick={() => counter=setCounter(1)} className='bg-gray-800 rounded-full w-10 h-10 focus:bg-orange-500 active:bg-orange-500'>1</button>
            </div>
            <div>
              <button onClick={() => counter=setCounter(2)} className='bg-gray-800 rounded-full w-10 h-10 focus:bg-orange-500 active:bg-orange-500'>2</button>
            </div>
            <div>
              <button onClick={() => counter=setCounter(3)} className='bg-gray-800 rounded-full w-10 h-10 focus:bg-orange-500 active:bg-orange-500'>3</button>
            </div>
            <div>
              <button onClick={() => counter=setCounter(4)} className='bg-gray-800 rounded-full w-10 h-10 focus:bg-orange-500 active:bg-orange-500'>4</button>
            </div>
            <div>
              <button onClick={() => counter=setCounter(5)} className='bg-gray-800 rounded-full w-10 h-10 focus:bg-orange-500 active:bg-orange-500'>5</button>
            </div>
          </div>
        </div> 
        <div className='pb-4 py-2'>
          <button onClick={submit} className='bg-orange-600 px-24 py-2 lg:px-32 tracking-widest rounded-full uppercase text-white p hover:bg-white hover:text-orange-500'>Submit</button>
        </div>
      </div>
      </>
      )}
